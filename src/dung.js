...
function Dung(_game) {
	...
	this.drop = function() {
		...
		var incr = index++;
		if (incr > 100) incr = Math.random()*10; // 최대 속도 (incr 속도가 어느정도 달했을 때 꾸준히 어느정도의 속도를 유지한)
...
DungGame.prototype = {
	...
	addScore : function(value) {
		...
		this.showMessage("clear!", 1500, this.gameReady.bind(this));
		}
	},
